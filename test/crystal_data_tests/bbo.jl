...
pm1 = find_nearest_pm(48u"°", 0.0u"°", [:o, :o, :e], BBO; lambda_r1=0.5321u"µm", lambda_b=0.26605u"µm", temp=293u"K")
@test isapprox(pm1.theta_pm, 47.62u"°", atol=ustrip(u"rad", 2u"°")) 

pm2 = find_nearest_pm(38.39u"°", 0.0u"°", [:e, :o, :e], BBO; lambda_r1=1.0642u"µm", lambda_b=0.35473u"µm", temp=293u"K")
...
pm3 = find_nearest_pm(45.50u"°", 0.0u"°", [:o, :e, :e], BBO; lambda_r1=1.3188u"µm", lambda_b=0.4396u"µm", temp=293u"K")
...
pm4 = find_nearest_pm(58.4u"°", 0.0u"°", [:o, :e, :e], BBO; lambda_r1=1.0642u"µm", lambda_b=0.35473u"µm", temp=293u"K")
