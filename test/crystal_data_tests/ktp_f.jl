...
pm1 = find_nearest_pm(90u"°", 24.59u"°", [:lo, :hi, :lo], KTP_H; lambda_r1=1.0642u"µm", lambda_b=0.5321u"µm", temp=293u"K") 
...
pm2 = find_nearest_pm(57.95u"°", 90.0u"°", [:lo, :hi, :lo], KTP_H; lambda_r1=2.9365u"µm", lambda_b=2.9365u"µm" / 2, temp=293u"K")
@test all(isnothing.(pm2.o_or_e_r1_r2_b)) || all(pm2.o_or_e_r1_r2_b .== [:o, :e, :o])
@test isapprox(pm2.theta_pm, 57.95u"°", atol=ustrip(u"rad", 4u"°"))

pm3 = find_nearest_pm(56.22u"°", 90.0u"°", [:lo, :hi, :lo], KTP_H; lambda_r1=1.2u"µm", lambda_b=1.2u"µm" / 2, temp=293u"K")
@test all(isnothing.(pm3.o_or_e_r1_r2_b)) || all(pm3.o_or_e_r1_r2_b .== [:o, :e, :o])
@test isapprox(pm3.theta_pm, 56.22u"°", atol=ustrip(u"rad", 4u"°"))

pm4 = find_nearest_pm(67.47u"°", 0.0u"°", [:lo, :hi, :lo], KTP_H; lambda_r1=1.2u"µm", lambda_b=1.2u"µm" / 2, temp=293u"K")
